...
namespace Engine
{
    ...
    partial class frmPet : System.Windows.Forms.Form
    {
        ...
        private DarkUI.Controls.DarkRadioButton _optCustomStats;
        ...
        internal DarkUI.Controls.DarkRadioButton optCustomStats
        {
            ...
            get
            {
                return _optCustomStats;
            }

            
            set
            {
                if (_optCustomStats != null)
                {
                }

                _optCustomStats = value;
                if (_optCustomStats != null)
                {
                }
            }
        ...
        private DarkUI.Controls.DarkRadioButton _optAdoptStats;
        ...
        internal DarkUI.Controls.DarkRadioButton optAdoptStats
        {
            ...
            get
            {
                return _optAdoptStats;
            }

            
            set
            {
                if (_optAdoptStats != null)
                {
                }

                _optAdoptStats = value;
                if (_optAdoptStats != null)
                {
                }
            }
        ...
        internal Panel pnlCustomStats
        {
            ...
            get
            {
                return _pnlCustomStats;
            }

            
            set
            {
                if (_pnlCustomStats != null)
                {
                }

                _pnlCustomStats = value;
                if (_pnlCustomStats != null)
                {
                }
            }
        ...
        private DarkUI.Controls.DarkRadioButton _optLevel;
        ...
        private DarkUI.Controls.DarkRadioButton _optDoNotLevel;
        ...
        internal DarkUI.Controls.DarkRadioButton optDoNotLevel
        {
            ...
            get
            {
                return _optDoNotLevel;
            }

            
            set
            {
                if (_optDoNotLevel != null)
                {
                }

                _optDoNotLevel = value;
                if (_optDoNotLevel != null)
                {
                }
            }
        ...
        private DarkUI.Controls.DarkNumericUpDown _nudPetExp;
        ...
        private DarkUI.Controls.DarkNumericUpDown _nudMaxLevel;
        ...
        private DarkUI.Controls.DarkNumericUpDown _nudPetPnts;
        ...
        private DarkUI.Controls.DarkCheckBox _chkEvolve;
        ...
        private DarkUI.Controls.DarkNumericUpDown _nudEvolveLvl;
        ...
        internal DarkUI.Controls.DarkNumericUpDown nudEvolveLvl
        {
            ...
            get
            {
                return _nudEvolveLvl;
            }

            
            set
            {
                if (_nudEvolveLvl != null)
                {
                }
        ...
        private DarkUI.Controls.DarkComboBox _cmbEvolve;
