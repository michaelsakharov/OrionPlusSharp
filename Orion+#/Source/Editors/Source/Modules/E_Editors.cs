...
#region Map Editor
		...
		internal static void MapPropertiesInit()
		{
			...
			frmMapEditor.Default.nudFogAlpha.Value = E_Types.Map.FogAlpha;
			...
			if (Button == (int) MouseButtons.Left)
			{
				...
				else if (E_Globals.SelectedTab == 2)
				{
					...
					if (frmMapEditor.Default.optLight.Checked)
					{
						...
						E_Types.Map.Tile[E_Globals.CurX, E_Globals.CurY].Data3 = Convert.ToInt32(E_Globals.LightShadows);
					}
				}
