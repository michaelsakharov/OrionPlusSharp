...
namespace Engine
{
    public class modPathfinding
    {
        ...
        //=========================================================
        //
        //public static mapMatrixRec[] mapMatrix = new mapMatrixRec[MAX_MAPS + 1];
        //
		...
		//	if (modTypes.Map[MapNum].NPC_Map(MapNpcNum, MapNum).pathLoc>=1) {
		//		x = modTypes.Map[MapNum].NPC_Map(MapNpcNum, MapNum).arPath(modTypes.Map[MapNum].NPC_Map(MapNpcNum, MapNum).pathLoc-1).x;
		//		y = modTypes.Map[MapNum].NPC_Map(MapNpcNum, MapNum).arPath(modTypes.Map[MapNum].NPC_Map(MapNpcNum, MapNum).pathLoc-1).y;
		//		// up
		//		if (y<modTypes.Map[MapNum].NPC_Map(MapNpcNum, MapNum).y) {
		//			if (CanNpcMove(MapNum, MapNpcNum, DIR_UP)) {
		//				NpcMove(MapNum, MapNpcNum, DIR_UP, MOVING_WALKING);
		//				modTypes.Map[MapNum].NPC_Map(MapNpcNum, MapNum).pathLoc -= 1;
		//				return;
		//			}
		//		}
		//		// down
		//		if (y>modTypes.Map[MapNum].NPC_Map(MapNpcNum, MapNum).y) {
		//			if (CanNpcMove(MapNum, MapNpcNum, DIR_DOWN)) {
		//				NpcMove(MapNum, MapNpcNum, DIR_DOWN, MOVING_WALKING);
		//				modTypes.Map[MapNum].NPC_Map(MapNpcNum, MapNum).pathLoc -= 1;
		//				return;
		//			}
		//		}
		//		// left
		//		if (x<modTypes.Map[MapNum].NPC_Map(MapNpcNum, MapNum).x) {
		//			if (CanNpcMove(MapNum, MapNpcNum, DIR_LEFT)) {
		//				NpcMove(MapNum, MapNpcNum, DIR_LEFT, MOVING_WALKING);
		//				modTypes.Map[MapNum].NPC_Map(MapNpcNum, MapNum).pathLoc -= 1;
		//				return;
		//			}
		//		}
		//		// right
		//		if (x>modTypes.Map[MapNum].NPC_Map(MapNpcNum, MapNum).x) {
		//			if (CanNpcMove(MapNum, MapNpcNum, DIR_RIGHT)) {
		//				NpcMove(MapNum, MapNpcNum, DIR_RIGHT, MOVING_WALKING);
		//				modTypes.Map[MapNum].NPC_Map(MapNpcNum, MapNum).pathLoc -= 1;
		//				return;
		//			}
		//		}
